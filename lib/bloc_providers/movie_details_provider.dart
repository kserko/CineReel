...
class MovieDetailsProvider extends InheritedWidget {
  ...
  static MovieDetailsBloc of(BuildContext context) =>
      (context.inheritFromWidgetOfExactType(MovieDetailsProvider) as MovieDetailsProvider)
          .movieDetailsBloc;

  MovieDetailsProvider({Key key, MovieDetailsBloc movieDetailsBloc, Widget child})
