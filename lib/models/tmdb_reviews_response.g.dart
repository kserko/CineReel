...
Map<String, dynamic> _$TMDBReviewsResponseToJson(TMDBReviewsResponse instance) => <String, dynamic>{
      'id': instance.id,
      'page': instance.page,
...
TMDBReview _$TMDBReviewFromJson(Map<String, dynamic> json) {
  return TMDBReview(json['author'] as String, json['content'] as String, json['id'] as String,
      json['url'] as String);
}

Map<String, dynamic> _$TMDBReviewToJson(TMDBReview instance) => <String, dynamic>{
