...
class TMDBMovieDetails extends Object with _$TMDBMovieDetailsSerializerMixin {
	...
	String findRottenTomatoesRating() {
		OMDBRating rating = omdbMovie.ratings.firstWhere((OMDBRating rating) =>
		rating.source == "Rotten Tomatoes", orElse: () => null);
	...
	String getDirector() {
		if (credits != null) {
			Crew director = credits.crew.firstWhere((Crew crew) => crew.job == "Director", orElse: () =>
			null);
