...
import 'package:flutter_bloc_movies/ui/movies_list_widget.dart';
...
class StreamComponent extends StatelessWidget {
  MovieBloc movieBloc;
	...
	Widget build(BuildContext context) {
		...
		return Column(children: [Flexible(child: buildStreamBuilder(TabKey
				.kNowPlaying, TabKey.kNowPlaying.index))
		]);
	}

	StreamBuilder<MoviesState> buildStreamBuilder(TabKey
	tabKey, int tabIndex) {
					    	...
					    	child: Stack(
					    		children: <Widget>[
					    			...
					    			MoviesResultWidget(
					    				movieBloc: movieBloc,
					    				tabKey: tabKey,
					    				items: data is MoviesPopulated ? data.movies : [],
					    			),
					    		],
					    	),
					    ),
